...
if($action == "Save")
{
   // print_r($_GET);
		...
		if($section=="possessionletter"){
           $sql ="SELECT * FROM `draft_document1` WHERE section='possessionletter' and `grouptenantmasid`=".$groupmasid;
           $sql1 ="SELECT * FROM `draft_document2` WHERE section='possessionletter' and `grouptenantmasid`=".$groupmasid;
