...
<html>
<head>
<title>SCD Allocation Summary</title>
<?php
    session_start();
...
$(document).ready(function() {
	...
	var a = "<strong>"+$('#buildingmasid option:selected').text()+"</strong>";
        ...
        {            
            var url="load_scdallocation_smry.php";
...
<body id="dt_example">    
    ...
    <p><font size="+1" color="#000066"><b>SCD ALLOCATION - SUMMMARY</b> </font> </p><hr color="#000066" height="2px"></br>
