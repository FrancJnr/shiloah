...
try
{
    ...
    //expledgermasid ='15' expledgermasid exp id
    $direct_water_cost=0;
    ...
    $table .="<tr>
                <td colspan='2'>DIRECT GENCOST:</td><td>$direct_water_cost</td>                
                <td colspan='9'></td>
            </tr>";
    $table .="<tr>";
    $table .="<th>S.No</th>";
    ...
    $sql1 = "select c.leasename,c.tradingname, a.grouptenantmasid,d.size,d.shopcode
                from advance_rent a
            ...
            UNION
            select c1.leasename,c1.tradingname, a1.grouptenantmasid,d1.size,d1.shopcode
                from invoice a1
        ...
        while($row1a = mysql_fetch_assoc($result1b)) // no of tenants available for the building
        {
           ...
           if($row1a['tradingname'] =="")
            ...
            {                                
                ...
                $gcost = $direct_water_cost*$totalsqrft/$totalsqrft_g;
                $watercost='watercost'.$n;            
                $table .="<td id=$watercost name=$watercost idd = $n class='watercost'>".number_format($gcost, 0, '.', ',')."</td>";
                $watercost_t +=$gcost;
            }            
        }  
    }    
...
$table .="<td align='right'><input type='hidden' id='lastrow' name='lastrow' value='$n' size='50px;'/>$grandmnths</td>";//total months chrged
$table .="<td align='right' id='totalsqrftmc' name='totalsqrftmc'></td>";//total sqrft charged
$table .="<td align='right' id='watercost' name='watercost'>$watercost_t</td>";//total water cost
