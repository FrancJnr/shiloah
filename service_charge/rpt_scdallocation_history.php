...
<html>
<head>
<title>SCD Allocation History</title>
<?php
    session_start();
...
$(document).ready(function() {
	...
	var a = "<strong>"+$('#buildingmasid option:selected').text()+"</strong>";
        ...
        {            
            var url="load_scdallocation_history.php";
...
<body id="dt_example">    
    ...
    <p><font size="+1" color="#000066"><b>SCD ALLOCATION HISTORY</b> </font> </p><hr color="#000066" height="2px"></br>
