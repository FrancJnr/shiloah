...
try
{
    ...
    $table .="<tr>
                <td>
                        GENCOST:$appgencot<input type='hidden' id='appgencost' name='appgencost' value='$appgencot' style='width:150px;'/>
                            <input type='hidden' id='hid_transexpgenmasid' name='hid_transexpgenmasid' value='$transexpgenmasid'/>
                            <input type='hidden' id='hid_transexpmasid' name='hid_transexpmasid' value='$transexpmasid'/>                            
                        KW Value:<input type='text' id='kwvalue' name='kwvalue' value='$kwvalue' style='width:50px;'/>
                            <input type='hidden' id='hid_totalsqrft' name='hid_totalsqrft' value=''/>
                </td>
                <td colspan='17' align='right'><button type='submit' id='btnSave' name='btnSave' value='Save'>Save</button>
                &nbsp;&nbsp;&nbsp;
                <button type='submit' id='btnSave' name='btnSave' value='Delete'>Delete</button></td></tr>";
    $table .="<tr>";
    $table .="<th>S.No</th>";
    $table .="<th>Tenant</th>";
    $table .="<th>Sqrft</th>";
...
$table .="<td align='right'></td>";//total months chrged
$table .="<td align='right' id='totalsqrftmc' name='totalsqrftmc'></td>";//total sqrft charged
$table .="<td align='right'></td>";//connected kw
$table .="<td align='right'></td>";//additional kw chrged
$table .="<td align='right' id='totalkw' name='totalkw'></td>";//total KW
$table .="<td align='right' id='totalkva' name='totalkva'></td>";//total KVA
$table .="<td align='right' id='totalkvapc' name='totalkvapc'></td>";//total KVA %

$table .="<td align='right' id='chrgddircost' name='chrgddircost'></td>";//total chrd cost
$table .="<td align='right' id='chrgdcomcost' name='chrgdcomcost'></td>";//total common cost
$table .="<td align='right' id='gencost' name='gencost'></td>";//total gen cost
        ...
        while($row1a = mysql_fetch_assoc($result1a)) // no of tenants available for the building
        {
           ...
           $sqltenant = "select leasename,tradingname,tenancyrefcode from mas_tenant a
            ...
            {                                
                ...
                //connetd kw
                $connkw = 'connkw'.$n;                
                $table .="<td><input type='text' id=$connkw name=$connkw idd = $n value='$connkw_dbval' style='width:50px;' class='txtGen'/></td>";
                ...
                $table .="<td>
                        <input type='text' id=$addikw name=$addikw idd = $n value='$addikw_dbval' style='width:50px;' class='txtGen'/>
                        
                        <input type='hidden' id='$hid_totalkw' name='$hid_totalkw' value='$totalkw_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_totalkva' name='$hid_totalkva' value='$totalkva_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_netkva' name='$hid_netkva' value='$totalkvapc_dbval' style='width:50px;'/>
                        
                        <input type='hidden' id='$hid_chrgddircost' name='$hid_chrgddircost' value='$chrgddircost_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_chrgdcomcost' name='$hid_chrgdcomcost' value='$chrgdcomcost_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_gencost' name='$hid_gencost' value='$gencost_dbval' style='width:50px;'/>
                        </td>";
...
{    
    ...
    {        
        ...
        $table .="<tr>";
            ...
            $table .="<td>
                        <input type='text' id=$commonkw name=$commonkw idd = $n value='$commonkw_dbval' style='width:50px;' class='txtGenCommon'/>
                        
                        <input type='hidden' id='$hid_totalkw' name='$hid_totalkw' value='$totalkwcom_dbval'  style='width:50px;'/>
                        <input type='hidden' id='$hid_totalkva' name='$hid_totalkva' value='$totalkvacom_dbval'  style='width:50px;'/>
                        <input type='hidden' id='$hid_netkva' name='$hid_netkva' value='$totalkvapccom_dbval'  style='width:50px;'/>
                        
                        
                        <input type='hidden' id='$hid_chrgddircost' name='$hid_chrgddircost' value='$chrgddircostcom_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_chrgdcomcost' name='$hid_chrgdcomcost' value='$chrgdcomcostcom_dbval' style='width:50px;'/>
                        <input type='hidden' id='$hid_gencost' name='$hid_gencost' value='$gencostcom_dbval' style='width:50px;'/>
                    </td>";
            //Total KW
