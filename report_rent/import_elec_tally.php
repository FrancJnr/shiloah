          ...
          //  echo $worksheetTitle."<br>";
           ...
           // echo $highestRow."<br>";
            ...
            for ($r = 2; $r <= $highestDataRow; $r++) {             
             ...
             $invoicemanmasid=0;$invoicedescmasid=0;$value=0;$vat=0;$amount=0; $remarks="";$remark="";$meterno=0; $opening=0; $closing=0; $units=0;$rate=0;
              for ($col = 0; $col < 15; $col ++) {
                  ...
                  {
					  // if(empty($val)){
						 //  die("Empty Fields in Excel File!");
					  // }
                ...
                // echo $remarks;
                  ...
                  if($amount >0)
                  {
                   ...
                   //  echo $invoiceno."<br>";
                    ...
                    // $invoiceno++;
                     $tenancyrefcode =gettenancyrefcode($grouptenantmasid);//$tenantcode;
   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <VOUCHER VCHTYPE="Sales" ACTION="Create" OBJVIEW="Accounting Voucher View">
      ...
      <ALLLEDGERENTRIES.LIST>
       <LEDGERNAME>Electricity Charges Income-'.$shortname.'</LEDGERNAME>
       <VOUCHERFBTCATEGORY/>
       <GSTCLASS/>
...
//End of Tally POST
                         ...
                         /*   $ins1 ="insert into invoice_man_mas(companymasid,invoiceno,fromdate,todate,toaddress,buildingmasid,grouptenantmasid,premise,totalvalue,totalvat,totalamount,remarks,createdby,createddatetime)
                            ...
                            else
                            {
                               ...
                               $invoicedescmasid=29; //// Direct Electricity Consumption
