          ...
          //  echo $worksheetTitle."<br>";
           ...
           // echo $highestRow."<br>";
            ...
            for ($r = 2; $r <= $highestDataRow; $r++) {             
             ...
             $invoicemanmasid=0;$invoicedescmasid=0;$value=0;$vat=0;$amount=0; $remarks="";
              for ($col = 0; $col < 10; $col ++) {
				  ...
				  // $sql ="select grouptenantmasid from mas_tenant where tenantcode='$tenantcode'";
                    $result = mysql_query($sql);
                    //print_r($result);W
                    if($result!=null)
                    {
...
//                       $buildingmasid = $row['buildingmasid'];                                             
     ...
     //                }
                  ...
                  if($amount >0)
                  {
				   ...
				   $sql="SELECT `invoiceno` FROM `invoice_man_mas` WHERE 
				   `companymasid`='$companymasid' and `totalvalue`='$totalvalue' and `grouptenantmasid` ='$grouptenantmasid'";
				 // print_r($sql.'<br>');
				    $result =  mysql_query($sql);    
                     if($result != null) 
                     {
                     ...
                     $invoiceno =$row['invoiceno'];  //getinvno($companymasid);
						 }
					 }
					 
					 
					 $tenancyrefcode = gettenancyrefcode($grouptenantmasid);
					// die("Amount".$grouptenantmasid);
...
$allXML = '<?xml version="1.0"?>
   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <VOUCHER VCHTYPE="Sales" ACTION="Create" OBJVIEW="Accounting Voucher View">
      ...
      <ALLLEDGERENTRIES.LIST>
       <LEDGERNAME>Actual Service Charge-'.$shortname.'</LEDGERNAME>
       <VOUCHERFBTCATEGORY/>
       <GSTCLASS/>
 ...
 //die($allXML);
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
                ...
                //curl_close($ch);
               //   if(!is_null($response_1) && isset($response_1)){
               echo  "ASCTXN: $response_1 <br>................................................................</br>"; 
				//  }
			   //End of Tally POST
                     ...
                     /* $ins1 ="insert into invoice_man_mas(companymasid,invoiceno,fromdate,todate,toaddress,buildingmasid,grouptenantmasid,premise,totalvalue,totalvat,totalamount,remarks,createdby,createddatetime)
                            ...
                            else
                            {
                               ...
                               $invoicedescmasid=26; //// ASC charges
...
/*
       ...
       //$pdf->Output($buildingname, 'I');
        ...
        $pdf->Output("../../pms_docs/asc_invoices/".$companyname."_".$shortname.".pdf","F");
//        if($companymasid !=3)
...
*/
    ...
    {
      echo "Alert: No Files Selected, Please select actual service charges excel File."; 
      exit;
    }
