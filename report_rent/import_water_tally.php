   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <VOUCHER VCHTYPE="Sales" ACTION="Create" OBJVIEW="Accounting Voucher View">
      ...
      <ALLLEDGERENTRIES.LIST>
       <LEDGERNAME>Water Charges Income-'.$shortname.'</LEDGERNAME>
       <VOUCHERFBTCATEGORY/>
       <GSTCLASS/>
...
//End of Tally POST
                          ...
                          /*  $ins1 ="insert into invoice_man_mas(companymasid,invoiceno,fromdate,todate,toaddress,buildingmasid,grouptenantmasid,premise,totalvalue,totalvat,totalamount,remarks,createdby,createddatetime)
                            ...
                            else
                            {
                               ...
                               $invoicedescmasid=34; //// Direct water Charges
...
//                       }
                   //  $resultchk=null;  
                     $address ='<table cellpadding="2" >		
                        ...
                        $rentdetails .='<tr>
                                           <td>1.</td>
                                           <td>Direct Water Consumption</td>
       ...
       /* $rand=rand(999,100);
        ...
        $pdf->Output("../../pms_docs/water_invoices/".$companyname.".pdf","F");
//        if($companymasid !=3)
//        $pdf->Output($invfilepath.$companyname.".pdf","F"); */
    ...
    {
      echo "Alert: No Files Selected, Please select water charges excel File."; 
      exit;
    }
 }
 catch (Exception $err)
