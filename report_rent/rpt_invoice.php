...
$(document).ready(function() {
	...
	// Comment out signing Option
	 //   $('[id^="btnSignSave"]').live('click', function() {
	//if($("#buildingmasid").val() =="")
	//    {
	//	alert("Building Selection is mandatory.");
	//	$("#buildingmasid").focus();
 ...
 //   });
	...
	function invSignGen()
    {
        ...
        if($('#buildingmasid').val()!="")
        {
            $('#buildingDiv').empty();
	    var dataToBeSent = $("form").serialize();
	    window.open("load_invoice_esd.php?"+dataToBeSent, "Print PDF", "width=800,height=800,toolbar:false,");
            return false;           
        }
        else
        {
...
<form id="myForm" name="myForm" action="" method="post" target="_blank">
	...
	<tr>
        ...
        <tr>
			...
			<button type="button" id="btnSignSave" style="background-color: #4CAF50;" disabled >Sign and Save</button>
	    </td>		
	</tr>
    </table>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
