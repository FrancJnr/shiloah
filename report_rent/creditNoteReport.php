...
$(document).ready(function() {
    ...
    $('[id^="btnView"]').live('click', function() {
        ...
        if(buildingmasid !="")
        {
            ...
            var dataToBeSent = $("form").serialize();
              // alert(dataToBeSent);
              $("#buildingDiv").load("crdt_rpt.php?"+dataToBeSent).fadeIn("slow");
...
<p><font size="+1" color="#000066"> <b> CREDIT NOTE REPORT </b> </font> </p><hr color="#000066" height="2px"></br>
    <table cellpadding="5" cellspacing="5">
         <tr>            
            <td align="right" colspan="2">
                ...
                <input type="text" id="crdtFrom" name="crdtFrom" class="monthYear" style='width: 120px;' value='<?php  echo $start;?>' readonly/>
                <label for="to">to</label>
                <input type="text" id="crdtTo" name="crdtTo" class="monthYear" style='width: 120px;' value='<?php  echo $end;?>' readonly/>
