...
<?php
     ...
     function loadBuilding()
	{
		...
		if($result != null)
		{
			...
			echo($row['buildingname']."<input type='checkbox' class='checkbox1' id=".$row['buildingmasid']." name=".$row['buildingmasid']."> &nbsp;&nbsp");		
			}
		}
	}
//    function loadBuilding()
...
//    }
    ...
    function loadinvoicedesc()
    {
        ...
        if($result != null)
        {
			...
			//Rent
					if($val=='32'){
			echo("<label><input type='checkbox' class='checkbox2' name='$invoicedescmasid' value='$val' id='$val' checked disabled='disabled' />".$row['invoicedesc']."</label>");		
			...
			echo("<label><input type='checkbox' class='checkbox2' name='$invoicedescmasid' value='$val' id='$val' />".$row['invoicedesc']."</label>");		
                }                }
        }
    }
    //TODAY'S DATE
...
$(document).ready(function() {
	...
	var url="load_invd_itax_combined.php";
...
$("#chckall").change(function(){
    ...
    $(".checkbox2").attr("checked",status);
	$('input:checkbox').filter('#32').attr(":checked");
	$('input:checkbox').filter('#42').attr(":checked");
});
...
<form id="myForm" name="myForm" action="" method="post">
	...
	<input type='checkbox' class='checkbox2' name='chckall'  id='chckall'  />Check All	
