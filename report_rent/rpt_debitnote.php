...
$(document).ready(function() {
	...
	var url="load_details.php?action=debitnoteno";
	var dataToBeSent = $("form").serialize();	
	$.getJSON(url,dataToBeSent, function(data){
	    $.each(data.error, function(i,response){
		    if(response.s == "Success")
		    {
			$('#debitnoteno').val(response.result);
			$('#buildingmasid').empty();
    ...
    $('[id^="btnDraft"]').live('click', function() {
	    ...
	    {
	        var dataToBeSent = $("form").serialize();
	        window.open("view_debitnote.php?"+dataToBeSent, "Print PDF", "width=800,height=800,toolbar:false,");
	        return false;
	    }		  
    });
    $('[id^="btnSave"]').live('click', function() {
	    ...
	    {
	        var dataToBeSent = $("form").serialize();
	        window.open("save_debitnote.php?"+dataToBeSent, "Print PDF", "width=800,height=800,toolbar:false,");
	        return false;
	    }	    
    });
...
<form id="myForm" name="myForm" action="" method="post">
    <br>
    <h1 align='CENTER' style="background-color:#bbddff;color: #000000" >Debit Note</h1>
    <br>
    ...
    <table class='table6'>	
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Invoice No <input type="text" id="debitnoteno" name="debitnoteno" style="font-size: larger;" readonly/>
            </td>
        </tr>	
        <tr>
		<td>
    ...
    <div id='display'>
        ...
        <span class='span_cont'>Debit Note List:</span><div style='height:8px'></div>
<?php
$directory="../../pms_docs/debitnote/";
