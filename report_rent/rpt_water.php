...
$(document).ready(function() {	
	...
	$('#cc').html("");	
	var r = confirm("Are you sure, You want to Import Water Charges?");
        if(r==true)
        {
            itemimport();
        }	
	...
	$('#cc').html("");	
	var r = confirm("Are you sure, You want to Import Water Charges To Tally?");
        if(r==true)
        {
            itemimporttotally();
        }	
    ...
    {
        $('#cc').html("");			
        var url="import_water_tally.php";	
        $("#form2").ajaxSubmit({
            url:url,	    
            data:$(this).serialize(),
            datatype:"json",
...
<body id="dt_example" style="width: 90%">
    ...
    <br>
    <h1 align='CENTER'>WATER CHARGE INVOICE</h1>
    <br><br>
	...
	<span class='span_cont'>Available Water Invoices:</span><div style='height:8px'></div>
<?php
$directory="../../pms_docs/water_invoices/";
