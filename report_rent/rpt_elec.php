...
$(document).ready(function() {	
	...
	$('#cc').html("");	
	var r = confirm("Are you sure, You want to Import Electricity Charges?");
        if(r==true)
        {
            itemimport();
        }	
	...
	$('#cc').html("");	
	var r = confirm("Are you sure, You want to Import Electricity Charges To Tally?");
        if(r==true)
        {
            itemimporttotally();
        }	
...
<body id="dt_example" style="width: 90%">
    ...
    <br>
    <h1 align='CENTER'>ELECTRICITY CHARGE INVOICE</h1>
    <br><br>
	...
	<span class='span_cont'>Available Electricity Invoices:</span><div style='height:8px'></div>
<?php
$directory="../../pms_docs/electricity_invoices/";
...
while ($file = readdir($handler)) {  
   ...
   foreach ($file_dates as $file_dates){       
	...
	$type = "Dbf File";
      ...
      // echo stripos($file, "Developers");
      
        
//        $cocode=substr($file, 0, 11);   
//          
...
//            }
//       $strpos=3;
//       $strpos=stripos($file, "Shiloah");
//       echo $companymasid;
//       if(stripos($file, "Katangi")==true){
//           echo "yeah";
//       }else{
//           echo "Nada";
//       }
     //  echo stripos($file, "Shiloah");
       $link = $directory.$file;
       echo "<tr>";
       
        
      if(substr($file, 0, 7)=="Katangi" && $companymasid==3){
       echo "<td>$w</td>";
       ...
       echo "</tr>";
        ...
        }else  if(substr($file, 0, 7)=="Shiloah" && $companymasid==1){
       echo "<td>$w</td>";
       echo "<td><a href='$link' target='_blank'>$file</a></td>"; 
       echo "<td>$type</td>";
       echo "<td>".formatSizeUnits($size)."</td>";       
       ...
       echo "</tr>";
       //$w++;
        }else if(substr($file, 0, 9)=="Grandways" && ($companymasid==2)){
       echo "<td>$w</td>";
       echo "<td><a href='$link' target='_blank'>$file</a></td>";   
       echo "<td>$type</td>";
       echo "<td>".formatSizeUnits($size)."</td>";       
