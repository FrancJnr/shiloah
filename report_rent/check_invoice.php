...
while($row = mysql_fetch_assoc($result))
{
	...
	{	
	    ...
	    $tenantmasid = $row1['tenantmasid'];
	     ...
	     $sql2="select b.shopcode ,b.size,a.leasename,a.tradingname,c.age as 'rentcycle',c.shortdesc,a.renewal,a.tenantcode,a.buildingmasid,
			...
			$sql3="select a.tenantmasid,b.amount as rent,f.amount as sc,b.fromdate,	c.leasename,c.tradingname,s.shoptype,	
				...
				if($row3['tradingname'] !="")
				{
				    $tradingname ="<br><center>T/A</center><br>";
