...
//	exit;
//companymasid=3&invoiceno=1379&fromdate=01+Jan+2017&todate=31+Jan+2017&grouptenantmasid=232
//&toaddress=AMAR+FABRICS+LIMITED%2CTenancy+Refcode%3A+%2CP.O.Box+%3A+941+-+40100%2CKISUMU.
//&buildingmasid=6&premise=KATANGI+-+Shop+no%3A+FGA+011-KT+++&sno_01=1&invoicedescmasid_01=38
//&value_01=12000&vat_01=0&total_01=12000&sno_02=2&invoicedescmasid_02=9&value_
//02=123&vat_02=20&total_02=143&totalvalue=12123&totalvat=20&totalamount=12143&remarks=test
...
try{
    ...
    $totalvalue=0;$totalvat=0;$totalamount=0;  $pin=""; $leasename=""; 
    $valuearray=array();
    $vatarray=array();
    $descarray=array();
    $buildingmasids="";
/* 	print_r($_GET);
    ...
    foreach($_GET as $key=>$val) {
        ...
        if(($invoicedescmasid != "invoicedescmasid") and ($sno !="sno") and ($value !="value") and ($vat!="vat") and ($amount!="total"))
        {
			...
			// additions for leasename and pin
			 else if($key == "pin"){
                $pin= $val;
            }
			 else if($key == "leasename"){
                $leasename= $val;
            }
...
/*         $sqltenantcode = "select tenantmasid from group_tenant_mas where grouptenantmasid=".$grouptenantmasid;
	...
	if($resultcode !=null)
	{
     ...
     // print_r($tenantmasid.":::::".$tenantcode.":::::".$desc);
//         $sqlbldname = "select buildingname, shortname from mas_building where buildingmasid='$val';";
//                $resultchkbld = mysql_query($sqlbldname);
//                if($result != null)
//                {
...
$creditac="";
$xml1="";$valuetotal=0;$vatarrayfloat=0;
//$valuearrayfloat=0;$vatarrayfloat=0;
$ascXML = '<?xml version="1.0"?>
 <ENVELOPE>
 <HEADER>
   ...
   <REQUESTDATA>
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <VOUCHER VCHTYPE="Sales" ACTION="Create" OBJVIEW="Accounting Voucher View">
      <DATE>'.$datenow.'</DATE>
      <STATENAME/>
      <NARRATION> Invoice #'.$taxinvoiceno.', '.$remarks.' </NARRATION>
...
if($descarray[$i]=="Interest Charges"){
    ...
    $creditac="Actual Service Charge-".$shortname;
     ...
     $creditac="Legal Charges Income-".$shortname;
 ...
 $allXML=$ascXML.$xml.$xml1.$xml2.$endxml;
//$txt= '<textarea rows="20" cols="40" style="border:none;">'.$allXML.'</textarea>';
// die($txt);
  /*Actual code for importing to Tally goes here*/
 
	 	//$server = 'http://192.168.0.8:9000';
...
//echo "SC: $response_3<br>SC VAT: $response_4"."<br>................................................................</br>";
