...
$table .= "</table>";
	...
	$insert = "insert into advance_rent (grouptenantmasid,fromdate,todate,invoiceno,months,rent,sc,createdby,createddatetime) values
		  ($grouptenantmasid,'$firstdate','$todate','$taxinvoiceno',$months,$rent,$sc,'$createdby','$createddatetime')";
	mysql_query($insert);
