...
<html>
<head>
<title>Actual Service Charge</title>
<?php
    session_start();
...
<body id="dt_example" style="width: 90%">
    ...
    <br>
    <h1 align='CENTER'>ACTUAL SERVICE CHARGE INVOICE</h1>
    <br><br>
	...
	<span class='span_cont'>Available ASC Invoices:</span><div style='height:8px'></div>
<?php
$directory="../../pms_docs/asc_invoices/";
