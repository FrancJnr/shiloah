...
while(list($key, $val) = each($_POST['isselected'])) 
{
	...
	//$src="../../pms_docs/creditnote/Grandways Venture Limited_331.pdf";
	 ...
	 $file = 'D:/xampp/htdocs/pms_docs/creditnote/'.$companyname1.'_'.$val.'.pdf';
...
{
$dest = 'D:/xampp/htdocs/pms_docs/creditnote/'.$companyname1.'_'.$val.'.pdf'; //pathto copy signed creditnoe to
