...
//			//first value
//			var b = "#rentval"+x;
//			var value = parseFloat(removeComma($(b).val()));
//			
//			//second value
//			var n = "#rentpercentage"+j;
//			var d = parseFloat($(n).val());
//			var s=Math.round((value*d/100)+value);
//			
//			//final value
//			var c = "#rentval"+i;
//			$(c).val(commafy(s.toFixed(2)));
//
//			j++;
//			x++;
//		});  
...
//                }
	...
	function fillDeposit()
	{
		if (($('#rentval0').val() !=0) || ($('#servicechrgval0').val() !=0))
		{
			...
			}else if (rentcycle == "Years & Months")
			     {
				//$('#rentcycle').remove();
                                $('#rentcycle').val("Years & Months");
                                rent =Math.round(parseFloat(removeComma($('#rentval0').val())));
				sc = Math.round(parseFloat(removeComma($('#servicechrgval0').val())));
						...
						$('#cc').html('');
						    ...
						    $('#selectOptionTblRent').show();
                                                	...
                                                	$.each(data.error, function(i,response){
                                                		...
                                                		{
									var renttblRows =response.msg;
                                                                        var rentcycle=response.rentcycle;
									var servicetblRows =response.tbl;
									var deposit =  response.deposit;
									$('#rentbody').append(renttblRows);
									$('#servicechrgbody').append(servicetblRows);
									$('#depositbody').append(deposit);
                                                                       ...
                                                                       var total=response.totalstotal;
                                                                        var age=response.age;
                                                                        $('#aged').val(age);
                                                                       // alert( $('#age').val());
                                                                       if((age == "months")  || (age=="month"))
                                                                            {
                                                                        total=Math.round(parseFloat(removeComma(total)));
                                                                        total=total-1;
                                                                        var from= $('#hidFromdateSc0').val();
                                                                        var to=$('#hidTodateRent'+total).val();
                                                                        var hike=$('#servicechrgpercentage'+total).val();
                                                                        var scfinalamount=$('#servicechrgval'+total).val();
                                                     
                                                                        var rentfinalamount=$('#rentval'+total).val();
                                                                        
                                                                        $('#from').html(from);
                                                                        $('#to').html(to);
                                                                        $('#hike').html(hike);
                                                                        $('#amounts').html(rentfinalamount);
                                                                        $('#periods').html( $('#term').val()+" ("+rentcycle+")");
                                                                        
                                                                        $('#scfrom').html(from);
                                                                        $('#scto').html(to);
                                                                        $('#schike').html(hike);
                                                                        $('#scamounts').html(scfinalamount);
                                                                        $('#scperiods').html($('#term').val()+" ("+rentcycle+")");
                                                                       
                                                                          $('#rentbody').hide();
                                                                          $('#servicechrgbody').hide();
                                                                          $('#rentsummary').show();
                                                                          $('#scsummary').show();
                                                                          ...
                                                                          $('#rentbody').show();
                                                                          $('#servicechrgbody').show()
                                                                          $('#rentsummary').hide();
                                                                          $('#scsummary').hide();
                                                                          
                                                                       }if (age=="Years & Months"){ 
                                                                         $('#aged').val("Years & Months");
                                                                         $('.hiderent').hide();
                                                                        ...
                                                                        $('#scperiods').html($('#term').val()+" ("+rentcycle+")");
                                                                        // $( "#rentcycle" ).hide();
                                                                         // $( "#rentcycle" ).parent().hide();
                                                                        //$("table tr:gt(5)").hide();
                                                                      //  $( '#rentbody tr' ).slice(1, 24).css( 'background', 'yellow' );
                                                                        for(var i=1; i<12; i++){
                                                                            
                                                                        $( "#rentval"+i ).parent().parent().hide();//css( "background-color", "red" );      
                                                                        $( "#servicechrgval"+i ).parent().parent().hide();
                                                                         }
                                                                        for(var i=13; i<24; i++){
                                                                        $( "#rentval"+i ).parent().parent().hide();//css( "background-color", "red" ); 
                                                                        $( "#servicechrgval"+i ).parent().parent().hide();
                                                                        ...
                                                                        for(var i=25; i<36; i++){
                                                                        $( "#servicechrgval"+i ).parent().parent().hide();//css( "background-color", "red" ); 
                                                                        $( "#rentval"+i ).parent().parent().hide();
                                                                        }
                                                                        for(var i=37; i<48; i++){
                                                                        $( "#servicechrgval"+i ).parent().parent().hide();//css( "background-color", "red" ); 
                                                                        $( "#rentval"+i ).parent().parent().hide();
...
//                                                                        for(var i=52; i<64; i++){
//                                                                        $( "#hidFromdateRent"+i ).parent().parent().hide();//css( "background-color", "red" ); 
//                                                                       
//                                                                        }
//                                                                        for(var i=65; i<77; i++){
//                                                                        $( "#hidFromdateRent"+i ).parent().parent().hide();//css( "background-color", "red" ); 
...
//                                                                        }
                                                                       // $(':input[value=""]').();
//                                                                       $( '#rentbody tr' ).slice( 13, 24).css( 'background', 'yellow' ); 
//                                                                       $( '#rentbody tr' ).slice( 14, 27).css( 'background', 'yellow' );
//                                                                       $( '#rentbody tr' ).slice( 28, 42).css( 'background', 'yellow' );
                                                                          //$('#rentbody').hide();
                                                                          //$('#servicechrgbody').hide();
                                                                          $('#rentsummary').show();
                                                                          $('#scsummary').show();
...
//                                                                        <td><b id="to"></b></td>
//                                                                        <td><b id="hike"></b></td>
//                                                                        <td><b id="amounts"></b></td>
//                                                                        <td><b id="periods"></b></td>
                                                                        
                                                                        //alert(counting);
                                                                         //$('#servicechrgbody').hide();
                                                                      ;
                                                                        //$('#renttbl tr:first').hide();
