...
//			
	...
	$("#offerlettermasid").change(function(){
		...
		if($offerlettermasid !="")
		{
			var url="load_offerletter_new.php?item=detailsOfferLetter&itemval="+$offerlettermasid;
			$.getJSON(url,function(data){
				$.each(data.error, function(i,response){
					if(response.s == "Success")
					{
					 ...
					 $.each(data.myResult, function(i,response){
						$('#cc').html('');
						    ...
						    $("#hidLeasename").val(response.leasename);
                                                    ...
                                                    var url="load_offerletter_new.php?item=loadTransDetFromOfferLetter&itemval="+$offerlettermasid;
						    $('#rentbody').html('');
						    $('#servicechrgbody').html('');
						    $('#depositbody').html('');
                                                    $.getJSON(url,function(data){
			...
			var url="load_offerletter_new.php?item=detailsRent&itemval="+$offerlettermasid;
			$.getJSON(url,function(data){
				$.each(data.error, function(i,response){
					if(response.s == "Success")
					{
	...
	function clearForm()
	{
        ...
        function addCompoundCycle (y,  m, frmdts, rentcycle){
               
                var m = parseInt(removeComma(m));	
                var y = parseInt(removeComma(y));	
                var x=m+y;
                var frmdt=Date.parse(frmdts).toString('dd-MM-yyyy');
               for (var j=0; j<x; j++){  
                $tbl  = "<tr>"; 
				if(j>y-1){
                
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('dd-MM-yyyy')+"<input type='hidden' id='hidFromdateRent"+j+"' name='hidFromdateRent"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('dd-MM-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"<input type='hidden' id='hidTodateRent"+j+"' name='hidTodateRent"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
                 } else{
                $tbl += "<td>"+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+"<input type='hidden' id='hidFromdateRent"+j+"' name='hidFromdateRent"+j+"' value="+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+"<input type='hidden' id='hidTodateRent"+j+"' name='hidTodateRent"+j+"' value="+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
...
//             
               ...
               function addCompoundCycleSC(y,  m, frmdts, rentcycle){
//               
                var m = parseInt(removeComma(m));	
                var y = parseInt(removeComma(y));	
                var x=m+y;
               ...
               for (var j=0; j<x; j++){  
                $tbl  = "<tr>";
				if(j>y-1){          
                //$tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('dd-MM-yyyy')+"<input type='hidden' id='hidFromdateSc"+j+"' name='hidFromdateSc"+j+"' value="+Date.parse(Date.parse(frmdt).addYears(y).toString('dd-MM-yyyy')).addMonths(j-y).toString('d-MM-yyyy')+"> </td>";
                //$tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"<input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(Date.parse(frmdt).addYears(y).toString('dd-MM-yyyy')).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('dd-MM-yyyy')+"<input type='hidden' id='hidFromdateSc"+j+"' name='hidFromdateSc"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('dd-MM-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"<input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
				 
				 } else{
                //$tbl += "<td>"+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+" <input type='hidden' id='hidFromdateSc"+j+"' name='hidFromdateSc"+j+"' value="+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+"> </td>";
                //$tbl += "<td>"+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+" <input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
                 $tbl += "<td>"+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+"<input type='hidden' id='hidFromdateSc"+j+"' name='hidFromdateSc"+j+"' value="+Date.parse(frmdt).addYears(j).toString('dd-MM-yyyy')+"> </td>";
                 $tbl += "<td>"+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+"<input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('dd-MM-yyyy')+"> </td>";
...
//
//          var d = Date.parse(frmdate).addYears(1).toString('dd-MM-yyyy');
//          var d2 = Date.parse(frmdate).addMonths(12).toString('dd-MM-yyyy');
//          alert(d.toString('dd-MM-yyyy'));
//          
//        if(period=="years"){
//         var todt=d;
