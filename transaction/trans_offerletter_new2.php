...
//			
	...
	function clearForm()
	{
        ...
        function addCompoundCycle (y,  m, frmdts, rentcycle){
                ...
                var x=m+y;
                var frmdt=Date.parse(frmdts).toString('d-M-yyyy');
               for (var j=0; j<x; j++){  
                $tbl  = "<tr>";
	...
	//firstDate.setDate(firstDate.getDate());
		 ...
		 //var newDate=new Date(new Date(frmdt).addYears(y).addMonths(j-y));
                
				if(j>y-1){
                
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('d-M-yyyy')+"<input type='hidden' id='hidFromdateRent"+j+"' name='hidFromdateRent"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('d-M-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('d-M-yyyy')+"<input type='hidden' id='hidTodateRent"+j+"' name='hidTodateRent"+j+"' value="+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('d-M-yyyy')+"> </td>";
                 } else{
                ...
                $tbl += "<td>"+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('d-M-yyyy')+"<input type='hidden' id='hidTodateRent"+j+"' name='hidTodateRent"+j+"' value="+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('d-M-yyyy')+"> </td>";
...
//               
               ...
               for (var j=0; j<x; j++){  
                $tbl  = "<tr>";
		if(j>y-1){          
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y).toString('d-M-yyyy')+"<input type='hidden' id='hidFromdateSc"+j+"' name='hidFromdateSc"+j+"' value="+Date.parse(Date.parse(frmdt).addYears(y).toString('d-M-yyyy')).addMonths(j-y).toString('d-M-yyyy')+"> </td>";
                $tbl += "<td>"+Date.parse(frmdt).addYears(y).addMonths(j-y+1).addDays(-1).toString('d-M-yyyy')+"<input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(Date.parse(frmdt).addYears(y).toString('d-M-yyyy')).addMonths(j-y+1).addDays(-1).toString('d-M-yyyy')+"> </td>";
                 } else{
                ...
                $tbl += "<td>"+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('d-M-yyyy')+" <input type='hidden' id='hidTodateSc"+j+"' name='hidTodateSc"+j+"' value="+Date.parse(frmdt).addYears(j+1).addDays(-1).toString('d-M-yyyy')+"> </td>";
                 }   
                if(j == 0){
