		...
		$.getJSON(url,dataToBeSent, function(data){
			...
			if(response.s == "Success")
			{
			    ...
			    $('#cc').html(response.msg);
                        ...
                        var a = confirm("Would you like to edit the tenant details?");
                         if (a== true)
                         {
                           parent.top.$('div[name=masterdivtest]').html("<iframe name='tenantiframe' src='masters/mas_tenant.php?action=new' id='the_iframe2' scrolling='yes' width='100%'></iframe>");   
                         }
