...
if($load == "loadTenant")
{
   $sql = "SELECT a.leasename, a.tenantmasid,a.tenanttypemasid,  a.tradingname,a.renewalfromid, a.tenantcode, a.companymasid, a.buildingmasid, a.blockmasid,
            ...
            a.active,b.shopcode from mas_tenant a inner join mas_shop b on b.shopmasid = a.shopmasid
	    where a.active= '1' and a.companymasid=$companymasid and a.tenantmasid not in (select tenantmasid from trans_offerletter where companymasid = $companymasid)
	    GROUP BY a.shopmasid ORDER BY a.leasename ASC";
}
   ...
   $result=mysql_query($sql);
	...
	if (mysql_num_rows($result) > 0)
	{
		...
		$rentcycle = $row["rentcycle"];
              ...
              //  $s2= preg_replace('/[0-9]+/', '', $term);
                //changes for Years and Months
                
                 if(count($term)=='4'){
                     $ym=true;
                     $s2=  strtolower($term[3]);
                }else{
                    $ym=false;
                    $s2="";
                     $s = strtolower($term[1]);
		    ...
		    $tr2 .=  "<td><input type='text' style='width:150px;' id='servicechrgval".$j."' dir='rtl' name='servicechrgval".$j."'  value='' readonly/></td>";
                    ...
                    $frmdt = $todt;
                       ...
                       { 
                        ...
                        $tr .=  "<tr><td colspan='5'><input type='hidden' id='rentcycle' name='rentcycle' style='width:20px;' value='$rentcycle'></tr>";
                    $tr .=  "<tr>		
                    <td>".$frmdt."<input type='hidden' id='hidFromdateRent".$f."' name='hidFromdateRent".$f."' value=".$frmdt."> </td>
                    <td>".$todt2."<input type='hidden' id='hidTodateRent".$f."' name='hidTodateRent".$f."' value=".$todt2."> </td>";
		    if($f == 0)
		    $tr .=  "<td><input type='text' style='width:150px;' id='rentpercentage".$f."' dir='rtl' name='rentpercentage".$f."' value='0' readonly/></td>";
		    else 
		    $tr .=  "<td><input type='text' style='width:150px;' id='rentpercentage".$f."' dir='rtl' name='rentpercentage".$f."' value='10'/></td>";
		    
		    if($f < 1)
                    $tr .=  "<td><input type='text' style='width:150px;' id='rentval".$f."' dir='rtl' name='rentval".$f."' value='' readonly /></td>";//changed recenntly
		    else
		    $tr .=  "<td><input type='text' style='width:150px;' id='rentval".$f."' dir='rtl' name='rentval".$f."'  value='' readonly/></td>";
		     ...
		     //-table 2 servicecharge
		    $tr2 .=  "<tr>		
                    <td>".$frmdt."<input type='hidden' id='hidFromdateSc".$f."' name='hidFromdateSc".$f."' value=".$frmdt."> </td>
                    <td>".$todt2."<input type='hidden' id='hidTodateSc".$f."' name='hidTodateSc".$f."' value=".$todt2."> </td>";
		    if($f== 0)
		    $tr2 .=  "<td><input type='text' style='width:150px;' id='servicechrgpercentage".$f."' dir='rtl' name='servicechrgpercentage".$f."' value='0' readonly/></td>";
		    else
                        $tr2 .=  "<td><input type='text' style='width:150px;' id='servicechrgpercentage".$f."' dir='rtl' name='servicechrgpercentage".$f."' value='10'/></td>";
		    
		    $tr2 .=  "<td><input type='text' style='width:150px;' id='servicechrgval".$f."' dir='rtl' name='servicechrgval".$f."'  value='' readonly/></td>";
    ...
    $custom = array('msg'=>$tr,'tbl'=>$tr2,'deposit'=>$tr3,'s'=>"Success"); 
