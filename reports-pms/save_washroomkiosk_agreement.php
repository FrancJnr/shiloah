...
$insert = "insert into rpt_washroomkiosk_agreement (grouptenantmasid,rowcontent,createdby,createddatetime) values ($groupmasid,$instr,'$createdby','$createddatetime')";
