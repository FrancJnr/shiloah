		...
		{		
			...
			{				
				//$tenantmasid = $row['tenantmasid'];                             
                                $leasename = strtoupper($row['leasename']);
...
$div0="<span id='span'>Print Preview Offerltter for  <font color='blue'> M/s. $leasename ($tenantcode)</font>&nbsp;
...
$pdf->setFontSubsetting(true);   
    ...
    $tenantdetails ='<table width="100%">		
		<tr style="line-height: 1.8px;">
			<td valign="top">TO:<br>&nbsp;&nbsp;&nbsp;&nbsp;<font size="9.5px"><b>'.$tname.'</b></font>,
						<br>&nbsp;&nbsp;&nbsp;&nbsp;Kind Attn:'.$tenantcpname.'.						
    ...
    $p9 ='<b>'.$x.'. SERVICE CHARGE:</b>
		...
		<li>
			<ol align="justify" style="line-height: 1.8px;letter-spacing:+0.100mm;font-stretch:100%;list-style-type: lower-roman;">
				...
				<li>Cost of providing vehicle parking facility.</li>
    ...
    $x++; 
    $p21 ='<br><b>'.$x.'. ACCEPTANCE OF OFFERLETTER:</b>
