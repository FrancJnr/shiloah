    ...
    {                
        ...
        if($offmasid !="")
        {
            ...
            {                
                ...
                //$d2= date("d-m-Y", strtotime(date("d-m-Y", strtotime($dtformat)) . " - 1  Day"));
                
                //$fromdDate = $dtformat;
                //$d1 = date("d-m-Y", strtotime(date("d-m-Y", strtotime($fromdDate)) . " + 1 Months"));
                //$d2 = date('d-m-Y',strtotime("-1 days $d1"));   	           
                //$todt =$newEndingDate;
...
//$table .= "<tr><td colspan='7' align=right>SUB TOTAL</td>";
//$table .="<td align=right></td></tr>";
