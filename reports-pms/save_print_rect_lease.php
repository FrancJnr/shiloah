	...
	{		
		...
		{		
			...
			$result = mysql_query($viewSql);
			 ...
			 $sqlv1= "select a.tenantmasid,a.tenanttypemasid,a.leasename,a.tradingname,
				...
				union
				select a.tenantmasid,a.tenanttypemasid,a.leasename,a.tradingname,
				a.tenantcode,a.companymasid,a.buildingmasid,a.blockmasid,a.floormasid,
				a.shopmasid,a.shoptypemasid,a.orgtypemasid,a.nob,
				a.agemasidlt,a.agemasidrc,a.agemasidcp,a.creditlimit,
				a.latefeeinterest,a.doo,a.doc,a.pin,a.regno,a.address1,a.address2,a.city,
...
if($rowcount >0)
{
	$sql = "delete * from rpt_rect_lease where grouptenantmasid =$groupmasid";
	$result = mysql_query($sql);
	$rowcount =0;
}
...
{   
   ...
   $PDF_PAGE_FORMAT= 'A4';
    ...
    // main page 1
    $pdf->AddPage();
    $pdf->SetFont('dejavusans','BU',18);
    $pdf->Cell(0,10,'DEED OF RECTIFICATION OF A SUB-LEASE',0,0,'C');   
    $pdf->SetFont('dejavusans','',11);    
    $p1 ='<table width="100%" >
		<tr style="line-height: 2.0px;">		  
                    <td align="justify">
			This Deed of Rectification is made at Kisumu this ...... day of ....2014 between 
                    </td>		
		</tr>
		</table>';
    $pdf->ln(2); 
    ...
    $filename .=" - Rec Lease ";
    //$pdf->Output("../../pms_docs/rect_leases/".$filename.".pdf","F");
    
    ////INSERT NEW LEASE
    $createdby = $_SESSION['myusername'];
    $createddatetime = $datetime;	
    //$insert = "insert into rpt_rect_lease (grouptenantmasid,createdby,createddatetime) values ($groupmasid,'$createdby','$createddatetime')";
    //mysql_query($insert);
