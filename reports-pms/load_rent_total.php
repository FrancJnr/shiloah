...
$table .="<tr><td colspan='18'><b>TOTAL INVOICE FOR THE PERIOD: ".strtoupper(date('d-M-Y', strtotime($_GET['fromdt']))." to ".date('d-M-Y', strtotime($_GET['todt'])))."</b></td></tr>";
$table .="<tr><td colspan='18'><b>$buildingname</td></tr>";
$table .="<tr><td colspan='3'></td><td colspan='9'><b>Invoice Details</td></tr>";
$table .="<tr>";
$table .="<th>S.NO</th>";
$table .="<th>Tenant</th>";
