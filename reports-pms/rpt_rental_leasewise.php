...
<html>
<head>
<title>RENTAL SCHEDULE LEASEWISE</title>
<?php
    session_start();
...
table.display thead th, table.display td {font-size: 13px; font-face:Calibri;}
.hover {
...
////$('#invdt').datepicker('setDate', date);
    ...
    $('#buildinglistTbl').hide();    
     ...
     function invGen()
     {
        ...
        {
            $('#buildingDiv').empty();
            var url="load_rental_leasewise.php";
...
<form id="myForm" name="myForm" action="" method="post">
    <br>
    <h1 align='CENTER'>RENTAL SCHEDULE LEASEWISE</h1>
    <br>
    <table>
         <tr>
		<td>
